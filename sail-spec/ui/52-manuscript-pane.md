...
- `src/components/review/ManuscriptPane.tsx`

---

우측 원고 패널 (아티팩트 룩). serif 렌더링, ```svg 펜스는 sanitize 후
인라인 SVG(figure)로, AI 수정부 하이라이트, draftManuscript 미리보기,
연필 아이콘 → 직접 편집(저장 시 onEdit) 지원.


---

### 파일: `src/components/review/ManuscriptPane.tsx` (312줄) — **verbatim, 글자 그대로 사용**
