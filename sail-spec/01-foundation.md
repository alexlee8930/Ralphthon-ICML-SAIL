...
- **의존성은 package.json 그대로** — 새 패키지 추가/버전 변경 금지. 폰트는
  @fontsource 셀프호스팅(inter·jetbrains-mono·source-serif-4), 외부 fetch 없음.
...
### 파일: `package.json` (48줄) — **verbatim, 글자 그대로 사용**

````json
{
  "name": "ralph-science-web",
  "private": true,
  "version": "0.0.0",
  "type": "module",
  "scripts": {
...
### 파일: `vite.config.ts` (15줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `tsconfig.json` (7줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `tsconfig.app.json` (27줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `tsconfig.node.json` (23줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `tailwind.config.js` (41줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `postcss.config.js` (6줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `index.html` (13줄) — **verbatim, 글자 그대로 사용**
...
<html lang="en">
  <head>
    ...
    <title>ICML SAIL with Ralph</title>
  </head>
  <body>
    <div id="root"></div>
...
### 파일: `.env.example` (2줄) — **verbatim, 글자 그대로 사용**
...
### 파일: `public/icons.svg` (24줄) — **verbatim, 글자 그대로 사용**
