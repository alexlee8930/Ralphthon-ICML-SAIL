...
import type { ArtifactInspector as ArtifactInspectorT, ArtifactTab } from "@/lib/artifacts";
...
// --- Private web copy of the reference `lib/download` (MIT): the desktop
// "Save As" dialog degrades to a Blob download plus a toast. ---
...
/** Save text with user feedback: Blob download in the browser, then a toast. */
async function saveTextWithFeedback(
  filename: string,
  text: string,
  mime = "text/plain",
): Promise<void> {
