// Private copy of the reference `@/components/markdown-viewer/MarkdownViewer`
// for the thread area (MIT — see LICENSES/open-science-MIT.txt). Markdown via
// react-markdown + remark-gfm, styled exactly as the reference.
